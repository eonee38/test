...
// show & hide password
var eye_icon_signup = document.getElementById('eye_icon_signup'); // 아이콘
var eye_icon_login = document.getElementById('eye_icon_login');  // input
var sign_up_password = document.getElementById("signup_password"); // 아이콘
var login_password = document.getElementById("login_password"); // input
