...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="home">detail</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.jsp"><img src="resources/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>프로젝트 기간</strong>: 2023.02.01 </li>
                <li><strong>프로젝트 URL</strong>: <a href="#">www.example.com</a></li>
              </ul>
            </div>
